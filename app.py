...
period_map = {"1m": "1d", "5m": "5d", "15m": "5d", "1h": "7d", "1d": "3mo"}
...
for ticker in tickers:
    ...
    # Only drop rows missing indicators, not core price data
    indicators = data[['RSI', 'MACD', 'Signal', 'SMA20', 'Pressure']].dropna()
    if indicators.empty:
        st.warning("Not enough data yet to show indicators. Try a longer interval.")
        continue
    ...
    # Chart shows full data including SMA overlay
    ...
    with st.expander("📄 Indicator Table"):
        st.dataframe(indicators.tail(10))
